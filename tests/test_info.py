...
def test_get_host_info():
    from mirismanagerclient.lib.info import get_host_info
...
def test_get_free_space_bytes():
    from mirismanagerclient.lib.info import get_free_space_bytes
...
def test_get_remaining_space():
    from mirismanagerclient.lib.info import get_remaining_space
